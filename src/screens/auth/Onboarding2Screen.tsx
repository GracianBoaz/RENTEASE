...
type NavigationProp = NativeStackNavigationProp<AuthStackParamList, 'Onboarding2'>;
    ...
    >
      <SafeAreaView style={styles.safeArea}>
        <View style={styles.content}>
          ...
          <Text style={styles.title}>Earn From Idle Items</Text>
          <Text style={styles.subtitle}>
            List your unused items and earn money while they sit idle at home. Turn your assets into income.
          </Text>
        </View>
